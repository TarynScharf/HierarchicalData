...
class FictitiousSampler(AbstractSampler[InitialConditions, Observation]):
    ...
    def _sample_the_observations(self, conditions: InitialConditions, number_of_analyses: int) -> Iterable[Observation]:
        ...
        feature1_observations = scipy.stats.uniform.rvs(loc=1, scale=5, size=number_of_analyses)

        # A feature influenced by all 3 initial conditions
        feature2 = (-0.4 * conditions.variable1 ** 2 + 0.0017 * conditions.variable1 + 48) * (conditions.variable2 / conditions.variable3)
        ...
        feature3_observations = 0.3*feature1_observations+0.23*feature2_observations + feature3_noise
        ...
        feature4_observations = 0.7 * conditions.variable1 + 0.3 * conditions.variable3 ** 2 + 0.13 * conditions.variable3 + feature4_noise
