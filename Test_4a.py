...
number_of_test_iterations = 1 #as each iteration is performed 10 times and the results of average, for Test 1 this amounts to 10 * number_of_test_iterations
...
plot_boxplots_of_subsampling_results(list_mse_el, list_mse_ol, results_folder)
